				...
				implements RoutingDecisionEngine, CommunityDetectionEngine
{
	...
	public boolean shouldSendMessageToHost(Message m, DTNHost otherHost)
	{
		if(m.getTo() == otherHost) {
			//System.out.println("one"+SimClock.getTime());
			return true;
		} // trivial to deliver to final dest
		...
		if(peerInCommunity && !meInCommunity){
			//System.out.println("two"+SimClock.getTime());
			return true;
		...
		else if(peerInCommunity) // we're both in the local community of destination
		{
			...
			{
				//System.out.println("there"+SimClock.getTime());
				return true;
			}
			else
				return false;
		...
		{
			//System.out.println("four"+SimClock.getTime());
			
			//System.out.println("connect "+de.getGlobalCentrality()+" "+this.getGlobalCentrality()+" "+otherHost+" "+SimClock.getTime());
			return true;
		}
		//System.out.println("connect "+de.getGlobalCentrality()+" "+this.getGlobalCentrality()+" "+otherHost+" "+SimClock.getTime());
		return false;
