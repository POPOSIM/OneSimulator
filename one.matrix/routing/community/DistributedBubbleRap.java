				...
				implements RoutingDecisionEngine, CommunityDetectionEngine
{
	...
	public void connectionUp(DTNHost thisHost, DTNHost peer){
		this.centrality.setupConnectionchange(thisHost, peer);
		this.centrality.getGlobalCentrality(connHistory,0);
		//System.out.println(this.centrality.getConnectionchange(thisHost, peer));
	}
	...
	{
		this.centrality.setdownConnectionchange(thisHost, peer);
		this.centrality.getGlobalCentrality(connHistory,0);
		try{
	...
	{
		return this.centrality.getGlobalCentrality(connHistory,1);
	}
